...
# osac.openshift.io/bare-metal-operator-bundle:$VERSION and osac.openshift.io/bare-metal-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= osac.openshift.io/bare-metal-operator
...
IMG ?= ghcr.io/ajamias/bare-metal-operator:latest
